...
$max = 104857600; //in bytes
	if (isset($_POST['project_entry'])) {
		...
		//echo $image_desc . "<br />"; 
		//include the text validation form
		require_once("../includes/validation2.php");	
	...
	<div id="add_body">
		...
		*/
    	...
    	<form id="project_entry" name="project_entry" method="post" action="" enctype="multipart/form-data">
            ...
            <div id="add_left">
            	<ul>
                    <li><label for="video_filename" class="video_file_text">Video Upload (max 100MB.)</label>
            	<input type="hidden" name="MAX_FILE_SIZE" value="<?php echo $max; ?>" />
            	<input class="video_file_text" name="video_filename" type="file" size="45"/></li>
               		<li>
                    <img src="sources/file_graphic.png" alt="file_size_graphic" /></li>
                    <li>
                
           	<a href="add.php?area_id=<?php echo $area_id ?>"/> Add an Image Instead </a></li>
           		</ul>
            </div>
